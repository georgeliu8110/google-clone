...
export default function WebSearchResults({results}) {
  return (
    <div className='w-full mx-auto px-3 sm:pb-24 pb-40 sm:pl-[5%] md:pl-[14%] lg:pl-52'>
      <p className='text-gray-600 text-sm mb-5 mt-3'> About {results.searchInformation.totalResults} results {`( ${results.searchInformation.searchTime} seconds )`}</p>
     {results.items.map(result=>
       <div key={result.cacheId} className='mb-8 max-w-xl'>
